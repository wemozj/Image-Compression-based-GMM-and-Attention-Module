...
class Analysis_net(nn.Module):
    ...
    def __init__(self, out_channel_N=192, out_channel_M=320):
        ...
        torch.nn.init.xavier_normal_(self.conv4.weight.data, (math.sqrt(2 * (out_channel_N + out_channel_M) / (out_channel_N + out_channel_N))))
        torch.nn.init.constant_(self.conv4.bias.data, 0.01)
        
        # global context attention module
        self.gcam_1 = GCAM(out_channel_N, out_channel_N)
        self.gcam_2 = GCAM(out_channel_M, out_channel_M)
