...
"""
used API, as follow:
TODO: rewrite annotation
* read_img
* get_MSSSIM(img1, img2)
* get_PSNR(img1, img2)
* get_MSE(img1, img2)


TODO: metric MS-SSIM have some problems
"""
import argparse
import numpy as np
import glob
...
from utils.ms_ssim_np import MultiScaleSSIM
import functools
...
def compare(inp_img, out_img, calc_ssim=True, calc_msssim=True, calc_psnr=True):
	...
	if inp_img.dtype != out_img.dtype:
		out_img.astype(inp_img.dtype)
	...
	def get_psnr():
		...
		return peak_signal_noise_ratio(inp_img, out_img)
...
if __name__ == '__main__':
	...
	input_img = '/home/zhujun/IMAGE_COMPRESSION/My_own_IC/data/data/Kodak/1.png'
	output_img = '/home/zhujun/IMAGE_COMPRESSION/My_own_IC/data/data/Kodak/1.png'
	ssim, msssim, psnr = compare(input_img, output_img)
	print("ssim:{}, ms-ssmi:{}, psnr:{}".format(ssim, msssim, psnr))
